                ...
                <div className="mt-4 space-y-4">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Discover the rich history, delectable cuisine, and
                        captivating traditions that make Japan a must-visit
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Unlock the secrets to securing the perfect scholarship
                        for your study abroad journey. Explore a wealth of
                        opportunities and tips to fund your international
                        education.
                      </p>
                    </div>
                  </Link>
                  ...
                  >
                    ...
                    <div>
                      <h3 className="text-lg font-medium">
                        Adapting to Student Life Abroad
                      </h3>
                      <p className="text-muted-foreground">
                        Discover practical tips and personal insights to help
                        you seamlessly transition into student life in a new
                        country. Embrace the challenges and thrive in your study
                        abroad adventure.
                      </p>
                    </div>
                  </Link>
